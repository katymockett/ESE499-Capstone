...
"""autogenerated by genpy from ros_i2cpwm_board_sub/ServosConfigRequest.msg. Do not edit."""
import codecs
import sys
...
class ServosConfigRequest(genpy.Message):
  ...
  _type = "ros_i2cpwm_board_sub/ServosConfigRequest"
...
"""
  __slots__ = ['servos']
  _slot_types = ['ros_i2cpwm_board_sub/ServoConfig[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = ros_i2cpwm_board_sub.msg.ServoConfig()
        _x = val1
        start = end
        end += 8
...
def _get_struct_4h():
    ...
    return _struct_4h
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from ros_i2cpwm_board_sub/ServosConfigResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class ServosConfigResponse(genpy.Message):
  ...
  _type = "ros_i2cpwm_board_sub/ServosConfigResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
class ServosConfig(object):
  _type          = 'ros_i2cpwm_board_sub/ServosConfig'
