...
"""autogenerated by genpy from ros_i2cpwm_board_sub/DriveModeRequest.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  _slot_types = ['string','float32','float32','float32','float32','ros_i2cpwm_board_sub/Position[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = ros_i2cpwm_board_sub.msg.Position()
        _x = val1
        start = end
        end += 4
...
def _get_struct_4f():
    ...
    return _struct_4f
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from ros_i2cpwm_board_sub/DriveModeResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class DriveModeResponse(genpy.Message):
  ...
  _type = "ros_i2cpwm_board_sub/DriveModeResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
class DriveMode(object):
  _type          = 'ros_i2cpwm_board_sub/DriveMode'
