...
if("TRUE" STREQUAL "TRUE")
  set(i2cpwm_board_SOURCE_PREFIX /home/ubuntu/catkin_ws/src/ros_i2cpwmboard_sub)
...
if(NOT "/home/ubuntu/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'i2cpwm_board' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/src/ros_i2cpwmboard_sub/${idir}'.  ${_report}")
    endif()
