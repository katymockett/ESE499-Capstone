...
(cl:defmethod cl:initialize-instance :after ((m <PositionArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PositionArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_i2cpwm_board_sub-msg:<PositionArray> is deprecated: use ros_i2cpwm_board_sub-msg:PositionArray instead.")))

(cl:ensure-generic-function 'servos-val :lambda-list '(m))
(cl:defmethod servos-val ((m <PositionArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_i2cpwm_board_sub-msg:servos-val is deprecated.  Use ros_i2cpwm_board_sub-msg:servos instead.")
  (servos m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PositionArray>)))
  ...
  "ros_i2cpwm_board_sub/PositionArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PositionArray)))
  "Returns string type for a message object of type 'PositionArray"
  "ros_i2cpwm_board_sub/PositionArray")
