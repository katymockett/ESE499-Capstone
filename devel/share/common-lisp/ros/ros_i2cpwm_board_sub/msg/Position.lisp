...
(cl:defmethod cl:initialize-instance :after ((m <Position>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Position)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_i2cpwm_board_sub-msg:<Position> is deprecated: use ros_i2cpwm_board_sub-msg:Position instead.")))
...
(cl:defmethod position-val ((m <Position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_i2cpwm_board_sub-msg:position-val is deprecated.  Use ros_i2cpwm_board_sub-msg:position instead.")
  (position m))
