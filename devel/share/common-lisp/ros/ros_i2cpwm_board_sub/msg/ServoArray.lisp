...
(cl:defclass <ServoArray> (roslisp-msg-protocol:ros-message)
  ((servos
    :reader servos
    :initarg :servos
    :type (cl:vector ros_i2cpwm_board_sub-msg:Servo)
   :initform (cl:make-array 0 :element-type 'ros_i2cpwm_board_sub-msg:Servo :initial-element (cl:make-instance 'ros_i2cpwm_board_sub-msg:Servo))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ServoArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ServoArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_i2cpwm_board_sub-msg:<ServoArray> is deprecated: use ros_i2cpwm_board_sub-msg:ServoArray instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ServoArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'servos)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'ros_i2cpwm_board_sub-msg:Servo))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ServoArray>)))
  ...
  "ros_i2cpwm_board_sub/ServoArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ServoArray)))
  "Returns string type for a message object of type 'ServoArray"
  "ros_i2cpwm_board_sub/ServoArray")
