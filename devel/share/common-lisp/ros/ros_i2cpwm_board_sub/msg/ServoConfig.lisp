...
(cl:in-package ros_i2cpwm_board_sub-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <ServoConfig>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ServoConfig)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_i2cpwm_board_sub-msg:<ServoConfig> is deprecated: use ros_i2cpwm_board_sub-msg:ServoConfig instead.")))

(cl:ensure-generic-function 'servo-val :lambda-list '(m))
(cl:defmethod servo-val ((m <ServoConfig>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_i2cpwm_board_sub-msg:servo-val is deprecated.  Use ros_i2cpwm_board_sub-msg:servo instead.")
  (servo m))

(cl:ensure-generic-function 'center-val :lambda-list '(m))
(cl:defmethod center-val ((m <ServoConfig>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_i2cpwm_board_sub-msg:center-val is deprecated.  Use ros_i2cpwm_board_sub-msg:center instead.")
  (center m))

(cl:ensure-generic-function 'range-val :lambda-list '(m))
(cl:defmethod range-val ((m <ServoConfig>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_i2cpwm_board_sub-msg:range-val is deprecated.  Use ros_i2cpwm_board_sub-msg:range instead.")
  (range m))

(cl:ensure-generic-function 'direction-val :lambda-list '(m))
(cl:defmethod direction-val ((m <ServoConfig>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_i2cpwm_board_sub-msg:direction-val is deprecated.  Use ros_i2cpwm_board_sub-msg:direction instead.")
  (direction m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ServoConfig>)))
  ...
  "ros_i2cpwm_board_sub/ServoConfig")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ServoConfig)))
  "Returns string type for a message object of type 'ServoConfig"
  "ros_i2cpwm_board_sub/ServoConfig")
