...
(cl:defmethod cl:initialize-instance :after ((m <Servo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Servo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_i2cpwm_board_sub-msg:<Servo> is deprecated: use ros_i2cpwm_board_sub-msg:Servo instead.")))
...
(cl:defmethod value-val ((m <Servo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_i2cpwm_board_sub-msg:value-val is deprecated.  Use ros_i2cpwm_board_sub-msg:value instead.")
  (value m))
