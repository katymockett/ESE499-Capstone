...
(cl:in-package ros_i2cpwm_board_sub-srv)
...
(cl:defclass <DriveMode-request> (roslisp-msg-protocol:ros-message)
  ((mode
   ...
   (servos
    :reader servos
    :initarg :servos
    :type (cl:vector ros_i2cpwm_board_sub-msg:Position)
   :initform (cl:make-array 0 :element-type 'ros_i2cpwm_board_sub-msg:Position :initial-element (cl:make-instance 'ros_i2cpwm_board_sub-msg:Position))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <DriveMode-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DriveMode-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_i2cpwm_board_sub-srv:<DriveMode-request> is deprecated: use ros_i2cpwm_board_sub-srv:DriveMode-request instead.")))

(cl:ensure-generic-function 'mode-val :lambda-list '(m))
(cl:defmethod mode-val ((m <DriveMode-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_i2cpwm_board_sub-srv:mode-val is deprecated.  Use ros_i2cpwm_board_sub-srv:mode instead.")
  (mode m))

(cl:ensure-generic-function 'rpm-val :lambda-list '(m))
(cl:defmethod rpm-val ((m <DriveMode-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_i2cpwm_board_sub-srv:rpm-val is deprecated.  Use ros_i2cpwm_board_sub-srv:rpm instead.")
  (rpm m))

(cl:ensure-generic-function 'radius-val :lambda-list '(m))
(cl:defmethod radius-val ((m <DriveMode-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_i2cpwm_board_sub-srv:radius-val is deprecated.  Use ros_i2cpwm_board_sub-srv:radius instead.")
  (radius m))

(cl:ensure-generic-function 'track-val :lambda-list '(m))
(cl:defmethod track-val ((m <DriveMode-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_i2cpwm_board_sub-srv:track-val is deprecated.  Use ros_i2cpwm_board_sub-srv:track instead.")
  (track m))

(cl:ensure-generic-function 'scale-val :lambda-list '(m))
(cl:defmethod scale-val ((m <DriveMode-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_i2cpwm_board_sub-srv:scale-val is deprecated.  Use ros_i2cpwm_board_sub-srv:scale instead.")
  (scale m))

(cl:ensure-generic-function 'servos-val :lambda-list '(m))
(cl:defmethod servos-val ((m <DriveMode-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_i2cpwm_board_sub-srv:servos-val is deprecated.  Use ros_i2cpwm_board_sub-srv:servos instead.")
  (servos m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <DriveMode-request>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'servos)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'ros_i2cpwm_board_sub-msg:Position))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DriveMode-request>)))
  ...
  "ros_i2cpwm_board_sub/DriveModeRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DriveMode-request)))
  "Returns string type for a service object of type 'DriveMode-request"
  "ros_i2cpwm_board_sub/DriveModeRequest")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<DriveMode-request>)))
  ...
  (cl:format cl:nil "~%~%~%~%~%~%~%~%~%~%string mode~%float32 rpm~%float32 radius~%float32 track~%float32 scale~%Position[] servos~%~%================================================================================~%MSG: ros_i2cpwm_board_sub/Position~%# the position message is used when configuring drive mode to~%# assign a  servo to a specific wheel positon in the drive system~%# postions are specific toe the desired drive mode~%# ackerman has only one position~%# 1 = drive~%# differential has two positons~%# 1 = left, 2 = right~%# mecanum has four positions~%# 1 = front left, 2 = front right, 3 = rear left, 4 = rear right~%# multiple servos/motors may be used for each positon~%~%int16 servo~%int16 position~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'DriveMode-request)))
  "Returns full string definition for message of type 'DriveMode-request"
  (cl:format cl:nil "~%~%~%~%~%~%~%~%~%~%string mode~%float32 rpm~%float32 radius~%float32 track~%float32 scale~%Position[] servos~%~%================================================================================~%MSG: ros_i2cpwm_board_sub/Position~%# the position message is used when configuring drive mode to~%# assign a  servo to a specific wheel positon in the drive system~%# postions are specific toe the desired drive mode~%# ackerman has only one position~%# 1 = drive~%# differential has two positons~%# 1 = left, 2 = right~%# mecanum has four positions~%# 1 = front left, 2 = front right, 3 = rear left, 4 = rear right~%# multiple servos/motors may be used for each positon~%~%int16 servo~%int16 position~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <DriveMode-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DriveMode-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_i2cpwm_board_sub-srv:<DriveMode-response> is deprecated: use ros_i2cpwm_board_sub-srv:DriveMode-response instead.")))

(cl:ensure-generic-function 'error-val :lambda-list '(m))
(cl:defmethod error-val ((m <DriveMode-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_i2cpwm_board_sub-srv:error-val is deprecated.  Use ros_i2cpwm_board_sub-srv:error instead.")
  (error m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DriveMode-response>)))
  ...
  "ros_i2cpwm_board_sub/DriveModeResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DriveMode-response)))
  "Returns string type for a service object of type 'DriveMode-response"
  "ros_i2cpwm_board_sub/DriveModeResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DriveMode)))
  ...
  "ros_i2cpwm_board_sub/DriveMode")