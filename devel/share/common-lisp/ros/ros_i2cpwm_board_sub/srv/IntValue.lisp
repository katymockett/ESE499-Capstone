...
(cl:defmethod cl:initialize-instance :after ((m <IntValue-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IntValue-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_i2cpwm_board_sub-srv:<IntValue-request> is deprecated: use ros_i2cpwm_board_sub-srv:IntValue-request instead.")))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <IntValue-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_i2cpwm_board_sub-srv:value-val is deprecated.  Use ros_i2cpwm_board_sub-srv:value instead.")
  (value m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<IntValue-request>)))
  ...
  "ros_i2cpwm_board_sub/IntValueRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'IntValue-request)))
  "Returns string type for a service object of type 'IntValue-request"
  "ros_i2cpwm_board_sub/IntValueRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <IntValue-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IntValue-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_i2cpwm_board_sub-srv:<IntValue-response> is deprecated: use ros_i2cpwm_board_sub-srv:IntValue-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<IntValue-response>)))
  ...
  "ros_i2cpwm_board_sub/IntValueResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'IntValue-response)))
  "Returns string type for a service object of type 'IntValue-response"
  "ros_i2cpwm_board_sub/IntValueResponse")
