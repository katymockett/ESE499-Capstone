...
(cl:defclass <ServosConfig-request> (roslisp-msg-protocol:ros-message)
  ((servos
    :reader servos
    :initarg :servos
    :type (cl:vector ros_i2cpwm_board_sub-msg:ServoConfig)
   :initform (cl:make-array 0 :element-type 'ros_i2cpwm_board_sub-msg:ServoConfig :initial-element (cl:make-instance 'ros_i2cpwm_board_sub-msg:ServoConfig))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ServosConfig-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ServosConfig-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_i2cpwm_board_sub-srv:<ServosConfig-request> is deprecated: use ros_i2cpwm_board_sub-srv:ServosConfig-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ServosConfig-request>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'servos)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'ros_i2cpwm_board_sub-msg:ServoConfig))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ServosConfig-request>)))
  ...
  "ros_i2cpwm_board_sub/ServosConfigRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ServosConfig-request)))
  "Returns string type for a service object of type 'ServosConfig-request"
  "ros_i2cpwm_board_sub/ServosConfigRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <ServosConfig-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ServosConfig-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_i2cpwm_board_sub-srv:<ServosConfig-response> is deprecated: use ros_i2cpwm_board_sub-srv:ServosConfig-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ServosConfig-response>)))
  ...
  "ros_i2cpwm_board_sub/ServosConfigResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ServosConfig-response)))
  "Returns string type for a service object of type 'ServosConfig-response"
  "ros_i2cpwm_board_sub/ServosConfigResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ServosConfig)))
  ...
  "ros_i2cpwm_board_sub/ServosConfig")