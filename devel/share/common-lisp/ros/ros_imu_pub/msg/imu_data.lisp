...
(cl:defmethod cl:initialize-instance :after ((m <imu_data>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'imu_data)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_imu_pub-msg:<imu_data> is deprecated: use ros_imu_pub-msg:imu_data instead.")))

(cl:ensure-generic-function 'heading-val :lambda-list '(m))
(cl:defmethod heading-val ((m <imu_data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_imu_pub-msg:heading-val is deprecated.  Use ros_imu_pub-msg:heading instead.")
  (heading m))

(cl:ensure-generic-function 'roll-val :lambda-list '(m))
(cl:defmethod roll-val ((m <imu_data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_imu_pub-msg:roll-val is deprecated.  Use ros_imu_pub-msg:roll instead.")
  (roll m))

(cl:ensure-generic-function 'pitch-val :lambda-list '(m))
(cl:defmethod pitch-val ((m <imu_data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_imu_pub-msg:pitch-val is deprecated.  Use ros_imu_pub-msg:pitch instead.")
  (pitch m))

(cl:ensure-generic-function 'lin_x-val :lambda-list '(m))
(cl:defmethod lin_x-val ((m <imu_data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_imu_pub-msg:lin_x-val is deprecated.  Use ros_imu_pub-msg:lin_x instead.")
  (lin_x m))

(cl:ensure-generic-function 'lin_y-val :lambda-list '(m))
(cl:defmethod lin_y-val ((m <imu_data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_imu_pub-msg:lin_y-val is deprecated.  Use ros_imu_pub-msg:lin_y instead.")
  (lin_y m))

(cl:ensure-generic-function 'lin_z-val :lambda-list '(m))
(cl:defmethod lin_z-val ((m <imu_data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_imu_pub-msg:lin_z-val is deprecated.  Use ros_imu_pub-msg:lin_z instead.")
  (lin_z m))
