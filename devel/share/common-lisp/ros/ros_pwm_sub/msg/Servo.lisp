...
(cl:defmethod cl:initialize-instance :after ((m <Servo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Servo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_pwm_sub-msg:<Servo> is deprecated: use ros_pwm_sub-msg:Servo instead.")))

(cl:ensure-generic-function 'servo-val :lambda-list '(m))
(cl:defmethod servo-val ((m <Servo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_pwm_sub-msg:servo-val is deprecated.  Use ros_pwm_sub-msg:servo instead.")
  (servo m))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <Servo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_pwm_sub-msg:value-val is deprecated.  Use ros_pwm_sub-msg:value instead.")
  (value m))
