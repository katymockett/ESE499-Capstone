...
(cl:defclass <ServoArray> (roslisp-msg-protocol:ros-message)
  ((servos
    :reader servos
    :initarg :servos
    :type (cl:vector ros_pwm_sub-msg:Servo)
   :initform (cl:make-array 0 :element-type 'ros_pwm_sub-msg:Servo :initial-element (cl:make-instance 'ros_pwm_sub-msg:Servo))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ServoArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ServoArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_pwm_sub-msg:<ServoArray> is deprecated: use ros_pwm_sub-msg:ServoArray instead.")))

(cl:ensure-generic-function 'servos-val :lambda-list '(m))
(cl:defmethod servos-val ((m <ServoArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_pwm_sub-msg:servos-val is deprecated.  Use ros_pwm_sub-msg:servos instead.")
  (servos m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ServoArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'servos)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'ros_pwm_sub-msg:Servo))
